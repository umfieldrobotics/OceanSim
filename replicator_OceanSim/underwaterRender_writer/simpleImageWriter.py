...
class ScanWriter(Writer):
    ...
    def _write_frame_data(self):
        ...
        # Write depth data to png
        file_path_depth = f"depth/depth_{self._frame_id}.png"
        self.backend.schedule(write_image, path=file_path_depth, data=self._frame_data["depth_data"])
