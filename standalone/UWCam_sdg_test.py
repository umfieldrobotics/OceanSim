...
def plot_all_debug(label_path, rgb_path, debug_path, instance_seg_path):
...
def plot_all(label_path, rgb_path, instance_seg_path):
    objects = load_kitti_label(label_path)
...
if __name__ == "__main__":
    ...
    if debug_mode:
        ...
        plot_all_debug(label_path, rgb_path, debug_path, instance_seg_path)
    else:
        plot_all(label_path, rgb_path, instance_seg_path)
