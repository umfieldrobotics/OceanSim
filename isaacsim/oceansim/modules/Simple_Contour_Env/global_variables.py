...
EXTENSION_TITLE = "Simple Contour Env"

EXTENSION_DESCRIPTION = "Simple contour environment for underwater sensor evaluation.\n" \
...
"otherwise the default simple_contour scene is loaded.\n" \
