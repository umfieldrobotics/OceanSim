...
# Custom import
from .scenario import Barometer_Scenario
...
class UIBuilder:
    ...
    def _on_init(self):
        ...
        self._scenario = Barometer_Scenario()
    ...
    def _setup_scene(self):
        ...
        DynamicCuboid(prim_path=robot_prim_path, size=0.5, color=np.array([1,0,0]))
        ...
        rob_rigid_prim = SingleRigidPrim(prim_path=robot_prim_path,
                                         mass=self._rob_mass)
        baro_prim_path = robot_prim_path + '/baro'
        self._baro = BarometerSensor(prim_path=baro_prim_path,g=10,noise_cov=1, water_surface_z=1.443)
    ...
    def _reset_scenario(self):
        ...
        self._scenario.setup_scenario(self._rob, self._baro)
