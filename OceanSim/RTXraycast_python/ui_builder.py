...
class UIBuilder:
    ...
    def _setup_scene(self):
        ...
        # set location of the viewport view
        set_camera_view(eye=[-5.0, 5.0, 5.0], target=[2.00, 2.00, 2.0], camera_prim_path="/OmniverseKit_Persp")

        # Create and install sonar sensor
        self._sonar_sensor = SonarSensor()
        self._sonar_sensor.attachSonar(robot_prim_path, np.array([0.05, 0, 0]))
    ...
    def _reset_scenario(self):
        ...
        self._scenario.setup_scenario(self._rob, self._sonar_sensor)
